...
export const UNITS_DATA: Record<string, UnitData> = {
  poa: {
    ...
    clinicalDirector: {
      name: 'Dra. Najara Ferreira Rodrigues',
      cro: 'CRO-SP 151880',
    ...
    dentists: [
      {
        ...
        cro: 'CRO-SP 151880',
        photoUrl: '/images/dentistas/dra-najara-rodrigues.webp'
      }
    ],
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Excelente atendimento na OdontoCompany Poá! A clínica é muito bonita, os profissionais super atenciosos e o tratamento de implante foi super tranquilo.',
        treatment: 'Implante Dentário'
      },
      {
        name: 'Mariana Silveira',
        rating: 5,
        text: 'Coloquei meu aparelho na OdontoCompany Poá e já vejo muita diferença no meu sorriso. Facilidade no pagamento e equipe maravilhosa!',
        treatment: 'Ortodontia'
      },
      {
        name: 'Luciana Ramos',
        rating: 5,
        text: 'Fiz clareamento e limpeza preventiva na unidade. Atendimento pontual, ambiente muito limpo e profissionais que passam muita segurança. Recomendo a todos de Poá e região.',
